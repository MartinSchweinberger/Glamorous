...
```{r 0, echo=FALSE, out.width= "45%", out.extra='style="float:right; padding:10px"'}
...
```{r 1, echo=FALSE, out.width= "45%", out.extra='style="float:right; padding:10px"'}
...
```{r 3, echo=FALSE, out.width= "45%", out.extra='style="float:right; padding:10px"'}
knitr::include_graphics("https://slcladal.github.io/images/cooee_aboriginal.png")
```
